...
use crate::universal::error::{DecodingError, DecodingResult, EncodingError, EncodingResult};
...
impl HolographicEncoder {
    ...
    fn generate_single_view(&self, data: &[u8], perspective: usize) -> EncodingResult<StoryView> {
        ...
        let actor = self
            .simple_encoder
            .dictionaries
            .get_actor(actor_index as usize)
        ...
        let action = self
            .simple_encoder
            .dictionaries
            .get_action(action_index as usize)
            .map_err(|_| EncodingError::DictionaryNotLoaded)?
            .to_string();
        ...
        let object = self
            .simple_encoder
            .dictionaries
            .get_object(object_index as usize)
            .map_err(|_| EncodingError::DictionaryNotLoaded)?
            .to_string();
        ...
        let modifier = self
            .simple_encoder
            .dictionaries
            .get_modifier(modifier_index as usize)
            .map_err(|_| EncodingError::DictionaryNotLoaded)?
            .to_string();
    ...
    fn solve_constraints(&self, views: &[StoryView]) -> DecodingResult<Vec<u8>> {
        ...
        let actor_index = self
            .simple_encoder
            .dictionaries
            .get_actor_index(&primary_view.actor)?;
        let action_index = self
            .simple_encoder
            .dictionaries
            .get_action_index(&primary_view.action)?;
        let object_index = self
            .simple_encoder
            .dictionaries
            .get_object_index(&primary_view.object)?;
        let modifier_index = self
            .simple_encoder
            .dictionaries
            .get_modifier_index(&primary_view.modifier)?;
