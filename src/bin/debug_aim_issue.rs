use four_word_networking::{
    encoder16k::UniversalEncoder16K, ultra_compact_encoder::UltraCompactEncoder,
            ...
            Ok(compressed) => {
                ...
                match encoder16k.encode(&compressed) {
                    Ok(encoded16k) => {
                        ...
                        padded[..compressed.len().min(6)]
                            .copy_from_slice(&compressed[..compressed.len().min(6)]);
                        ...
                        println!(
                            "      Raw indices: {} {} {} (third={} -> 'aim' at index 0)",
                            idx1, idx2, idx3, idx3
                        );
