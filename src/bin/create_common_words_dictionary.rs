...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    if needed > 0 {
        if needed <= uncommon_but_valid.len() {
            ...
            let safe_filtered: Vec<&str> = filtered_out.iter()
            ...
            while final_words.len() < 16384 {
                ...
                let really_bad = ["rape", "kill", "murder", "nazi", "fuck", "shit", "bvt", "xj", "xr", "uvw", "xyz"];
                let final_recovery: Vec<&str> = filtered_out.iter()
                ...
                if final_recovery.is_empty() {
                    ...
                    let last_resort: Vec<&str> = all_words.iter()
                        .filter(|w| !final_words.contains(w) && !really_bad.contains(w))
                        .take(still_needed)
                        .cloned()
                        .collect();
    ...
    println!("  Uncommon: {}", (final_words.len() - very_common.len() - common.len()).min(uncommon_but_valid.len()));
    ...
    println!("   Very common words at indices 0-{}", very_common.len() - 1);
    println!("   Common words at indices {}-{}", very_common.len(), very_common.len() + common.len() - 1);
...
fn assess_word_commonality(word: &str) -> WordCommonality {
    ...
    let filtered_words = [
        "rape", "kill", "murder", "nazi", "fuck", "shit", "penis", "vagina", 
        "cocaine", "heroin", "meth", "bvt", "zoa", "zea", "wahl", "xj", "xr", 
        "apio", "cps", "uvw", "www", "abey", "alle", "sparge", "yds", "kepler",
        "augur", "nigh", "gerry", "bok", "duh", "gab", "gag", "keg", "nag",
        "oaf", "pox", "pry", "pug", "rut", "wad", "wok", "yam", "yen", "yin",
        "zap", "zen", "zit", "pep", "pod", "tux", "ahoy", "fax", "wow", "huh",
        "hmm", "err", "umm", "ugh", "meh", "xyz", "css", "php", "asp", "jsp",
        "api", "gui", "cpu", "ram", "rom", "usb", "dvd", "lcd", "led", "gps",
        "wifi", "lan", "wan", "vpn", "dns", "tcp", "udp", "http", "https",
    ...
    let very_common_words = [
        ...
        "always", "among", "angry", "animal", "another", "answer", "anyone", "anything",
        "around", "asking", "beautiful", "because", "become", "before", "being", "believe",
        "better", "between", "building", "business", "cannot", "change", "children",
        "church", "closed", "coming", "company", "computer", "country", "course",
        "during", "early", "enough", "evening", "every", "everyone", "everything",
        "example", "family", "father", "feeling", "final", "first", "follow",
        "friend", "getting", "given", "going", "government", "great", "group",
        "hand", "happy", "having", "heard", "heart", "help", "here", "high",
        "home", "hope", "hour", "house", "human", "important", "information",
        "instead", "interest", "just", "keep", "kind", "know", "large", "last",
        "late", "later", "leave", "left", "life", "light", "line", "little",
        "live", "local", "long", "look", "love", "made", "make", "many",
        "maybe", "mean", "might", "mind", "money", "more", "most", "move",
        "much", "music", "must", "name", "national", "need", "never", "news",
        "next", "night", "nothing", "number", "office", "often", "only",
        "open", "order", "other", "over", "part", "people", "person", "place",
        "point", "possible", "power", "probably", "problem", "program", "public",
        "question", "quite", "really", "reason", "right", "said", "same",
        "school", "second", "seem", "several", "short", "should", "show",
        "since", "small", "social", "some", "something", "sometimes", "sound",
        "space", "speak", "special", "start", "state", "still", "story",
        "student", "study", "support", "sure", "system", "take", "talk",
        "teacher", "team", "tell", "than", "thank", "that", "their", "them",
        "then", "there", "these", "they", "thing", "think", "this", "those",
        "three", "through", "time", "today", "together", "tonight", "turn",
        "under", "understand", "university", "until", "used", "using", "very",
        "want", "water", "week", "well", "what", "when", "where", "which",
        "while", "white", "will", "with", "within", "without", "woman",
        "women", "word", "work", "world", "would", "write", "year", "years",
        "young", "your",
        
        // Common objects and concepts
        "table", "chair", "door", "window", "book", "paper", "phone", "computer",
        "car", "road", "tree", "flower", "garden", "park", "mountain", "river",
        "ocean", "beach", "city", "town", "street", "building", "hospital",
        "restaurant", "store", "market", "hotel", "airport", "train", "bus",
        "ship", "plane", "bicycle", "camera", "television", "radio", "music",
        "movie", "game", "sport", "football", "basketball", "baseball", "tennis",
        "swimming", "running", "walking", "cooking", "eating", "drinking",
        "sleeping", "reading", "writing", "learning", "teaching", "working",
        "playing", "traveling", "shopping", "driving", "flying", "singing",
        "dancing", "painting", "drawing", "listening", "watching", "talking",
        "laughing", "crying", "smiling", "helping", "caring", "loving",
        "sharing", "giving", "taking", "buying", "selling", "making", "creating",
        "building", "fixing", "cleaning", "washing", "cooking", "baking",
        "growing", "farming", "fishing", "hunting", "camping", "hiking",
        "climbing", "swimming", "surfing", "skiing", "skating", "riding",
        
        // Colors, numbers, time
        "black", "white", "brown", "green", "blue", "yellow", "orange", "purple",
        "pink", "gray", "silver", "golden", "bright", "dark", "light",
        "monday", "tuesday", "wednesday", "thursday", "friday", "saturday", "sunday",
        "january", "february", "march", "april", "june", "july", "august",
        "september", "october", "november", "december", "morning", "afternoon",
        "evening", "night", "today", "tomorrow", "yesterday", "weekend",
        "holiday", "birthday", "christmas", "summer", "winter", "spring", "autumn"
    ];
...
fn is_good_english_word(word: &str) -> bool {
    ...
    let good_endings = ["ing", "tion", "sion", "ment", "ness", "able", "ible", "ful", "less", "ward", "wise"];
    ...
    let good_beginnings = ["under", "over", "inter", "trans", "super", "anti", "auto", "multi"];
    ...
    let weird_combos = ["xj", "xr", "qx", "zx", "jx", "vx", "bx", "cx", "fx", "gx", "kx", "px", "wx"];
...
fn is_very_common_4_letter(word: &str) -> bool {
    let common_4_letter = [
        "able", "back", "ball", "base", "been", "best", "book", "call", "came", "can't",
        "care", "case", "come", "cool", "data", "days", "dead", "deal", "does", "done",
        "door", "down", "draw", "each", "easy", "else", "even", "ever", "eyes", "face",
        "fact", "fair", "fall", "fast", "fear", "feel", "feet", "file", "fill", "find",
        "fine", "fire", "firm", "fish", "five", "food", "foot", "form", "four", "free",
        "from", "full", "game", "gave", "gets", "girl", "give", "goes", "gold", "gone",
        "good", "hand", "hard", "have", "head", "hear", "help", "here", "high", "hold",
        "home", "hope", "hour", "huge", "idea", "into", "item", "join", "jump", "just",
        "keep", "kept", "kids", "kind", "knew", "know", "land", "last", "late", "lead",
        "left", "less", "life", "like", "line", "list", "live", "long", "look", "lose",
        "love", "made", "main", "make", "many", "mean", "mind", "miss", "more", "most",
        "move", "much", "must", "name", "near", "need", "news", "next", "nice", "nine",
        "none", "note", "open", "over", "page", "paid", "park", "part", "pass", "past",
        "pick", "plan", "play", "poor", "post", "pull", "push", "puts", "real", "rest",
        "rich", "ride", "ring", "road", "room", "rule", "runs", "safe", "said", "same",
        "save", "seem", "seen", "self", "sell", "send", "ship", "shop", "show", "shut",
        "side", "sign", "site", "size", "slow", "snow", "soft", "some", "song", "soon",
        "sort", "stay", "step", "stop", "such", "sure", "take", "talk", "tell", "term",
        "test", "text", "than", "that", "them", "then", "they", "this", "time", "told",
        "took", "tree", "true", "turn", "type", "upon", "used", "user", "uses", "very",
        "walk", "want", "warm", "ways", "week", "well", "went", "were", "what", "when",
        "will", "wind", "with", "word", "work", "year", "your"
    ];
