...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    if needed > 0 {
        if needed <= acceptable_words.len() {
            ...
            let really_bad = ["rape", "kill", "murder", "nazi", "fuck", "shit", "bvt", "xj", "xr"];
            let recoverable: Vec<&str> = filtered_out.iter()
            ...
            println!("\nAdded {} acceptable + {} recovered words to reach {} total", 
                acceptable_words.len(), recoverable.len(), final_words.len());
            
            if final_words.len() < 16384 {
                // Add back any remaining words to reach exactly 16384
                let remaining: Vec<&str> = filtered_out.iter()
                    .filter(|w| !final_words.contains(w))
                    .take(16384 - final_words.len())
                    .cloned()
                    .collect();
                final_words.extend(&remaining);
                println!("Added {} more words to reach exact total: {}", remaining.len(), final_words.len());
            }
        }
    }
    ...
    println!("   Excellent words at indices 0-{}", excellent_words.len() - 1);
    println!("   Good words at indices {}-{}", excellent_words.len(), excellent_words.len() + good_words.len() - 1);
...
fn categorize_word(word: &str) -> WordCategory {
    ...
    let excellent_words = [
        ...
        "house", "home", "family", "person", "people", "child", "children", "parent",
        "friend", "school", "teacher", "student", "book", "table", "chair", "door",
        "window", "water", "food", "money", "time", "day", "week", "month", "year",
        "work", "job", "business", "company", "office", "computer", "phone", "car",
        "road", "city", "country", "world", "life", "health", "love", "peace",
        "music", "art", "game", "sport", "movie", "story", "picture", "color",
        "animal", "dog", "cat", "bird", "tree", "flower", "garden", "park",
        "mountain", "river", "ocean", "sky", "sun", "moon", "star", "cloud",
        
        // Common adjectives
        "good", "great", "nice", "beautiful", "happy", "sad", "big", "small",
        "new", "old", "young", "easy", "hard", "fast", "slow", "hot", "cold",
        "clean", "dirty", "safe", "dangerous", "important", "interesting", "fun",
        "simple", "complex", "free", "expensive", "cheap", "rich", "poor",
        "healthy", "strong", "weak", "smart", "kind", "friendly", "helpful",
        
        // Common verbs
        "be", "have", "do", "make", "get", "take", "give", "go", "come", "see",
        "know", "think", "say", "tell", "ask", "answer", "speak", "talk", "listen",
        "hear", "look", "watch", "read", "write", "learn", "teach", "study",
        "work", "play", "run", "walk", "drive", "travel", "visit", "live",
        "eat", "drink", "sleep", "wake", "start", "stop", "finish", "continue",
        "help", "support", "protect", "save", "buy", "sell", "pay", "spend",
        "find", "search", "choose", "decide", "plan", "prepare", "organize",
        "manage", "control", "create", "build", "design", "improve", "change",
        "move", "turn", "open", "close", "enter", "exit", "join", "leave",
        ...
        // Basic concepts
        "place", "space", "area", "size", "part", "whole", "beginning", "middle",
        "end", "top", "bottom", "left", "right", "inside", "outside", "front",
        "back", "center", "corner", "side", "edge", "line", "point", "circle",
        "square", "round", "straight", "curved", "flat", "thick", "thin",
        "light", "dark", "bright", "clear", "loud", "quiet", "soft", "hard",
        "smooth", "rough", "sweet", "sour", "bitter", "fresh", "dry", "wet"
    ];
