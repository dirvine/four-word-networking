...
fn test_address_types(encoder: &UniversalEncoder16K) -> Result<(), Box<dyn std::error::Error>> {
    ...
    let sha256 = vec![
        0x6c, 0xa1, 0x3d, 0x52, 0xca, 0x70, 0xc8, 0x83, 0xe0, 0xf0, 0x04, 0x65, 0x52, 0x2d, 0xc7,
        0x6f, 0x9e, 0x22, 0xd5, 0x65, 0x9e, 0x34, 0x8e, 0x7a, 0x91, 0x01, 0xfe, 0x85, 0x22, 0x39,
        0x44, 0x15,
    ];
