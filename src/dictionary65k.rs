...
impl Dictionary65K {
    ...
    pub fn new() -> Result<Self, Dictionary65KError> {
        // Load the high-quality 65K wordlist (3-7 characters, curated)
        let wordlist_data = include_str!("../data/my_word_list_with_suffixes.txt");
        ...
        // Validate word quality (3-7 characters)
