...
fn test_ula_basic_addresses() {
    ...
    for (addr, description) in test_cases {
        ...
        assert!(!decoded.contains("fc00:fc00"), "Duplication bug detected for {}", description);
        assert!(!decoded.contains("fd00:fd00"), "Duplication bug detected for {}", description);
    }
}
...
fn test_ula_with_subnet_id() {
    ...
    let test_cases = vec![
        ...
        ("[fc00:1234:5678:9abc:def0::]:443", "[fc00:1234:5678:9abc::]:443"), // def0 is segment[4], will be lost
        ("[fd00:1234:5678:9abc::]:443", "[fd00:1234:5678:9abc::]:443"),
        ("[fd00:1234:5678:9abc:def0::]:443", "[fd00:1234:5678:9abc::]:443"), // def0 is segment[4], will be lost
...
fn test_ula_with_interface_id() {
    ...
    let test_cases = vec![
        ...
        ("[fc00:1234:5678:9abc::1]:443", "[fc00:1234:5678:9abc::]:443"),
        ("[fd00:1234:5678:9abc::1]:443", "[fd00:1234:5678:9abc::]:443"),
    ];
...
fn test_ula_edge_cases() {
    ...
    for (addr, description) in test_cases {
        ...
        assert!(decoded.starts_with("[fc") || decoded.starts_with("[fd"),
